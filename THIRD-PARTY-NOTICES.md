...
Chiffrium intègre les composants suivants, chacun sous sa propre licence. La liste affichée dans
...
publication du code de Chiffrium), et aucun composant sous GPL/AGPL n'est lié au code de l'application.
