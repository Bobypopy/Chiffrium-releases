# Chiffrium - cryptographic inventory and post-quantum migration
...
Chiffrium reads the code of a project - a Git repository or a folder on your disk - and produces the
...
|---|---|---|
| Windows 10/11 (64-bit) | `Chiffrium-Setup-<version>.exe` | Double-click, then follow the installer |
| Linux (Debian, Ubuntu...) | `chiffrium-desktop_<version>_amd64.deb` | `sudo apt install ./chiffrium-desktop_<version>_amd64.deb` |
| Linux (any distribution) | `Chiffrium-<version>.AppImage` | `chmod +x`, then run it; nothing is installed |
