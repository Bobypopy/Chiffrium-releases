# Chiffrium - inventaire cryptographique et migration post-quantique
...
Chiffrium lit le code d'un projet - un dépôt Git ou un dossier de votre disque - et produit l'inventaire
...
L'interface existe en français et en anglais ; le choix se fait dans la barre du haut.
...
|---|---|---|
| Windows 10/11 (64 bits) | `Chiffrium-Setup-<version>.exe` | Double-cliquer, puis suivre l'installateur |
| Linux (Debian, Ubuntu...) | `chiffrium-desktop_<version>_amd64.deb` | `sudo apt install ./chiffrium-desktop_<version>_amd64.deb` |
| Linux (toute distribution) | `Chiffrium-<version>.AppImage` | `chmod +x` puis lancer, rien à installer |
